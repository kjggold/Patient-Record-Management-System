            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($appointments as $appointment)
                    <tr id="row-{{ $appointment->id }}" class="hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $appointment->id }}
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                            {{ $appointment->service->service_name ?? '-' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <button class="text-amber-600 hover:underline"
                                    onclick="window.location.href='{{ route('appointments.edit', $appointment->id) }}'">Edit</button>
