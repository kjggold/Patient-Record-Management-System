...
@section('content')
    <div class="app flex min-h-screen">
        ...
        <!-- MAIN CONTENT -->
        <div class="flex-1 ml-60"> <!-- Add margin-left equal to sidebar width -->
            <main class="p-6">
    ...
    <!-- VIEW PATIENT MODAL -->
    <div id="viewModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 ml-60">
    ...
    <!-- ADD PATIENT MODAL -->
    <div id="addModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-50 overflow-y-auto py-8 ml-60">
    ...
    <style>
        /* === MODAL & FORM STYLES === */
        /* These styles ensure the modal appears correctly above sidebar */
        #addModal {
            z-index: 100;
        ...
        @media (max-width: 768px) {
            ...
            /* Adjust for mobile with sidebar */
            .flex-1.ml-60 {
                    ...
                    detailsDiv.innerHTML = `
                        <div class="col-span-2 text-center py-8">
                            <svg class="w-12 h-12 text-red-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
