        ...
        <div class="bg-white rounded-xl w-full max-w-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-4 text-sm">
                @foreach ($patients as $p)
                    ...
                    <div><b>Birth
                            Date:</b>{{ $p->date_of_birth_day }}/{{ $p->date_of_birth_month }}/{{ $p->date_of_birth_year }}
                    </div>
            ...
            <form method="POST" action="{{ route('patients.store') }}" id="patientForm">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <link
                            href='https://clinicaltables.nlm.nih.gov/autocomplete-lhc-versions/19.2.4/autocomplete-lhc.min.css'
                            rel="stylesheet">
