                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input list="patientList" id="patientNameInput" name="patient_name"
                                ...
                                oninput="updatePatientId()" required>
                        ...
                        <div class="form-group">
                            ...
                            <input list="serviceList" id="serviceNameInput" name="service_name"
                                ...
                                oninput="updateServiceId()" required>
                            ...
                            <input type="hidden" name="service_id" id="serviceIdHidden"
                        ...
                        <div class="form-group">
                            ...
                            <input list="doctorList" id="doctorNameInput" name="doctor_name"
                                ...
                                oninput="updateDoctorId()" onchange="updateSpecialityFromDoctor()" required>
                            <datalist id="doctorList">
                                @foreach ($doctors as $doctor)
                                    <option value="{{ $doctor->full_name }}" data-id="{{ $doctor->id }}"
                                        data-speciality="{{ $doctor->speciality }}" title="{{ $doctor->speciality }}">
