    ...
    <div class="relative min-h-screen">
        ...
        <div class="relative z-20 flex items-center justify-center min-h-screen px-4">
            <div
                ...
                @if (session('status'))
                    <div class="mb-4 rounded-lg bg-yellow-50 border border-yellow-400 text-yellow-900 px-4 py-3 text-sm">
                        {{ session('status') }}
                    </div>
                @endif
                ...
                @if($justRegistered)
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-700 mb-6">
                            Your account is pending approval from the main admin. You will receive an email once your account is activated.
                        </p>
                        <a href="{{ route('login') }}"
                           class="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200">
                            Back to Login
                        </a>
                    </div>
                @else
