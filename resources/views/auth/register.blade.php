        ...
        <div class="relative z-20 flex items-center justify-center min-h-screen px-4">
            <div
                ...
                <a href="{{ route('welcome') }}"
                    ...
                    aria-label="Cancel and return to welcome">
                    &times;
                </a>
                    ...
                    <div class="space-y-2">
                        <div class="relative">
                            ...
                            <button type="button" id="togglePassword"
                                ...
                                <svg id="eyeSlashIcon" class="w-5 h-5" fill="none" stroke="currentColor"
                                ...
                                <svg id="eyeIcon" class="w-5 h-5 hidden" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="space-y-2">
                        <div class="relative">
                            ...
                            <button type="button" id="toggleConfirmPassword"
                                class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none">
                                <!-- Eye slash icon (visible when password is hidden - DEFAULT) -->
                                <svg id="eyeSlashIconConfirm" class="w-5 h-5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21">
                                    </path>
                                ...
                                <!-- Eye icon (visible when password is shown) -->
                                <svg id="eyeIconConfirm" class="w-5 h-5 hidden" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @else
                    <p class="mt-8 text-center text-sm text-gray-500">
                        Please wait until the main admin approves your registration. You'll be able to log in after
                        approval.
                    </p>
                @endif
            </div>
