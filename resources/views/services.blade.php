                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900">General Consultation</h3>
                            <p class="text-gray-600 mt-2 text-sm">Fever, flu, headache, body pain</p>
                        </div>
                    </div>
                    <button onclick="openServiceModal(1)" class="mt-6 w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-300 text-sm">
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900">Child Health (Paediatrics)</h3>
                            <p class="text-gray-600 mt-2 text-sm">Child fever, cough, vaccination</p>
                        </div>
                    </div>
                    <button onclick="openServiceModal(2)" class="mt-6 w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-300 text-sm">
                        View Services & Doctors
                    </button>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900">Heart & Blood Pressure</h3>
                            <p class="text-gray-600 mt-2 text-sm">Hypertension, heart disease</p>
                        </div>
                    </div>
                    <button onclick="openServiceModal(3)" class="mt-6 w-full bg-red-500 hover:bg-red-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-300 text-sm">
                        View Services & Doctors
                    </button>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900">Diabetes Care</h3>
                            <p class="text-gray-600 mt-2 text-sm">Blood sugar monitoring</p>
                        </div>
                    </div>
                    <button onclick="openServiceModal(4)" class="mt-6 w-full bg-yellow-500 hover:bg-yellow-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-300 text-sm">
                        View Services & Doctors
                    </button>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900">Women's Health (OG)</h3>
                            <p class="text-gray-600 mt-2 text-sm">Pregnancy, menstrual issues</p>
                        </div>
                    </div>
                    <button onclick="openServiceModal(5)" class="mt-6 w-full bg-purple-500 hover:bg-purple-600 text-white font-medium py-2.5 px-4 rounded-lg transition-colors duration-300 text-sm">
                        View Services & Doctors
                    </button>
                </div>
            </div>
...
<script>
    ...
    const clinicData = {
        ...
        2: {
            ...
            illnesses: ['Child Fever', 'Cough & Cold', 'Vaccination', 'Growth Issues', 'Nutrition', 'Allergies', 'Skin Rashes', 'Behavior'],
            doctors: [
                {
                    id: 3,
                    name: 'Dr. May Zin',
        ...
        3: {
            ...
            description: 'Cardiac care and hypertension management',
            illnesses: ['Hypertension', 'Heart Disease', 'Cholesterol', 'Arrhythmia', 'Chest Pain', 'Palpitations', 'Edema', 'Shortness'],
            doctors: [
                {
                    id: 4,
                    name: 'Dr. Kyaw Myint',
        ...
        4: {
            ...
            illnesses: ['Type 2 Diabetes', 'Blood Sugar Control', 'Insulin Therapy', 'Diet Planning', 'Neuropathy', 'Retinopathy', 'Foot Care', 'Kidney'],
            doctors: [
                {
                    id: 5,
                    name: 'Dr. Hnin Ei',
                    speciality: 'Diabetes Specialist',
                    fee: '25,000 MMK',
                    experience: '10+ years',
        ...
        5: {
            name: 'Women\'s Health (OG)',
            description: 'Comprehensive women\'s health and obstetric care',
            illnesses: ['Pregnancy Care', 'Menstrual Disorder', 'Menopause', 'Fertility', 'Gynecology', 'Pap Smear', 'Breast Exam', 'Contraception'],
            doctors: [
                {
                    id: 6,
                    name: 'Dr. Ei Phyo',
                    speciality: 'OG Specialist',
                    fee: '30,000 MMK',
                    experience: '14+ years',
    ...
    function openServiceModal(id) {
        ...
        // Populate categories (using illnesses as categories)
        ...
        // Populate doctors in card layout
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-3 mb-4">
                        ...
                        <div class="flex items-center text-gray-700">
                            ...
                            <span class="text-sm">${doctor.rating}/5 Rating</span>
                        </div>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <div class="flex justify-between items-center">
                            ...
                            <button onclick="bookAppointment(${doctor.id}, '${doctor.name}')"
    ...
    function bookAppointment(doctorId, doctorName) {
        alert(`Booking appointment with ${doctorName}\n\nThis would redirect to appointment booking page in a real application.`);
        // In real application:
        // window.location.href = `/appointments/book?doctor_id=${doctorId}&doctor_name=${encodeURIComponent(doctorName)}`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add click animation to all service buttons
        const serviceButtons = document.querySelectorAll('button[onclick^="openServiceModal"]');
