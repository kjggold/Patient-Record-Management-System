                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <a href="{{ route('patient-history.download-report', $patient) }}"
                            ...
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M12 4v12m0 0l-4-4m4 4l4-4"></path>
                            </svg>
                            Download Report
                        </a>
                    </div>
                            ...
                            <div class="p-6">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-medium text-gray-800">{{ $patient->phone_number ?? 'N/A' }}
                                        </p>
                                    </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="px-6 py-12 text-center">
                                                <h3 class="text-lg font-medium text-gray-700 mb-2">No appointment history
                                                    found</h3>
                    ...
                    <div class="mt-6 bg-white rounded-xl shadow px-4 py-4 border-t">
                        <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                            ...
                            <div class="text-sm text-gray-600">
                                Showing {{ $paginatedAppointments->firstItem() }} to
                                {{ $paginatedAppointments->lastItem() }} of {{ $paginatedAppointments->total() }}
                                {{ Str::plural('appointment', $paginatedAppointments->total()) }}
                            </div>
                    ...
                    @if ($paginated->hasPages())
                        <div class="mt-6 bg-white rounded-xl shadow px-4 py-4 border-t">
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <!-- Showing info -->
                                <div class="text-sm text-gray-600">
                                    Showing {{ $paginated->firstItem() }} to {{ $paginated->lastItem() }} of
                                    {{ $paginated->total() }} {{ Str::plural('appointment', $paginated->total()) }}
                                </div>
