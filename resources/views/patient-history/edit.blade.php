                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" id="full_name"
                                value="{{ old('full_name', $patient->full_name) }}" placeholder="Enter Full Name" required>
                            @error('full_name')
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone_number" id="phone_number"
                                value="{{ old('phone_number', $patient->phone_number) }}" placeholder="Enter Phone Number"
                                required>
                            @error('phone_number')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address"
                                value="{{ old('address', $patient->address) }}" placeholder="Enter Address" required>
                            @error('address')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="blood_type" id="blood_type" required>
                                <option value=""
                                    {{ old('blood_type', $patient->blood_type) == '' ? 'selected' : '' }}>Select</option>
                                <option value="A+"
            ...
            if (phoneInput.value) {
                ...
                if (phone.length > 0) {
                    if (phone.length <= 3) {
                        ...
                        phone = '(' + phone.substring(0, 3) + ') ' + phone.substring(3, 6) + '-' + phone.substring(
                            6, 10);
                    }
                }
