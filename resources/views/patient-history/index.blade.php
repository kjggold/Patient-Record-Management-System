            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6"
                ...
                @forelse($patients as $patient)
                    <div class="patient-card bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full"
                        ...
                        data-blood="{{ strtolower($patient->blood_type ?? '') }}" data-age="{{ $patient->age ?? '' }}">
                        <div class="p-4 flex-1">
                            {{-- Patient Header --}}
                            <div class="mb-3">
                                <div class="flex justify-between items-start mb-2">
                                    <div class="flex-1 min-w-0">
                                        <h2 class="patient-name text-base font-semibold text-gray-800 truncate">
                                    ...
                                    <span
                                        class="patient-id px-2 py-1 bg-sky-100 text-sky-700 text-xs font-medium rounded-full flex-shrink-0 ml-2">
                                        ID: {{ $patient->id }}
                                    </span>
                                </div>
                                ...
                                <div class="space-y-1 text-xs text-gray-600">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="truncate">Last visit:
                                            {{ $patient->last_visit ?? 'No visits yet' }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 mb-3">
                                @if ($patient->address)
                                    <div class="flex items-start">
                                        <svg class="w-3 h-3 text-gray-400 mt-0.5 mr-1 flex-shrink-0" fill="none"
                                        ...
                                        <span
                                            class="patient-address text-xs text-gray-600 flex-1">{{ Str::limit($patient->address, 35) }}</span>
                                    </div>
                                @endif
                                ...
                                <div class="flex items-center justify-between pt-2 border-t border-gray-100">
                                    @if ($patient->blood_type)
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="patient-blood text-xs text-gray-600">{{ $patient->blood_type }}</span>
                                        </div>
                                    @endif
                                    ...
                                    {{-- Total Visits --}}
                                    <div class="flex items-center">
                                        <svg class="w-3 h-3 text-sky-500 mr-1" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <span
                                            class="text-xs font-bold text-sky-600">{{ $patient->total_visits ?? 0 }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                @empty
                    <div id="emptyState"
                        class="col-span-1 sm:col-span-2 lg:col-span-3 xl:col-span-4 bg-white rounded-xl shadow-lg border border-gray-200 p-8 text-center">
                        ...
                        <div class="flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div class="mb-4 md:mb-0">
                                <p class="text-sm text-gray-700">
                                    ...
                                    to
                                    <span
                                        class="font-medium">{{ min($patients->currentPage() * 12, $patients->total()) }}</span>
                                    of
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function highlightText(card, searchTerm) {
                ...
                const textElements = card.querySelectorAll(
                    '.patient-name, .patient-doctor, .patient-phone, .patient-address, .patient-blood, .patient-age, .patient-id'
                    );
