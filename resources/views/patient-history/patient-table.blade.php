            ...
            <thead class="bg-gradient-to-r from-sky-50 to-indigo-50">
                <tr>
                    ...
                    <th scope="col"
                        ...
                        NAME</th>
                    <th scope="col"
                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">BLOOD TYPE
                    </th>
                    <th scope="col"
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($patients as $patient)
                    @php
                        ...
                        $dischargesQuery = DB::table('discharges')->where('patient_name', $patient->full_name);
                        ...
                        if ($dateType != 'all') {
                            if ($dateType == 'today') {
                                ...
                                $dischargesQuery->whereBetween('created_at', [
                                    now()->startOfWeek(),
                                    now()->endOfWeek(),
                                ]);
                            } elseif ($dateType == 'month') {
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                @if ($patient->blood_type)
                                    <span
                                        class="px-2 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium">{{ $patient->blood_type }}</span>
                                @else
