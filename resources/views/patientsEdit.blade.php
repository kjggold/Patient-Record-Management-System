                ...
                <form method="POST" action="{{ route('patients.update', $patient->id) }}" id="patientForm">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="age" placeholder="Enter Age" min="0" max="120"
                                required value="{{ old('age', $patient->age) }}">
                            @error('age')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <textarea id="allergies" name="allergies" rows="2" placeholder="List any allergies">{{ old('allergies', $patient->allergies) }}</textarea>
                            @error('allergies')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
